...
class TutorService:
    ...
    def analyze_question(self, request: TutorAnalyzeRequest) -> TutorAnalyzeResponse:
        ...
        summary = self._build_analysis_summary(request.question, concepts, evidence_passages)
    ...
    def advance_session(self, session_id: str) -> TutorSessionResponse:
        ...
        next_index = int(session["currentStepIndex"]) + 1
    ...
    def _build_teaching_plan(
        ...
        steps = [
            ...
            TeachingStep(
                ...
                content={
                    "markdown": self._build_practice_markdown(mode, primary_label),
    ...
    def _build_analysis_summary(
        ...
        return f"问题“{question}”当前最相关的主概念是 {primary}，并已抽取 {len(evidence_passages)} 条优先原文证据供 tutor 编排使用。"
    ...
    @staticmethod
    def _build_practice_markdown(mode: TutorMode, primary_topic: str) -> str:
    ...
    @staticmethod
    def _build_practice_prompt(mode: TutorMode, primary_topic: str) -> str:
        if mode == TutorMode.QUIZ:
